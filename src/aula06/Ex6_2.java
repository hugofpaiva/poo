...
public class Ex6_2 {
	public static void main(String[] args) {
		...
		r2 = sc.nextInt();
		Circulo c1 = new Circulo("Azul",r1, p1);
		Circulo c2 = new Circulo("Laranja",r2, p2);
		...
		alturaR = sc.nextInt();
		Retangulo R1 = new Retangulo("Vermelho",comprimentoR, alturaR);
		...
		t3 = sc.nextInt();
		Triangulo T1 = new Triangulo("Verde",t1, t2, t3);
